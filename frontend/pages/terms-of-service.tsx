      ...
      <main id="main">
        ...
        <div
          ...
          <div className="font-sans font-light text-md break-words">
            ...
            <p>
              When you enter your email and keyword, your email is stored indefinitely in
              order to further notify you when your keyword matches any word in the
              announced company name, case insensitive.
            </p>
            <br/>
            <p>
            ...
            <br/>
            <p>
              We will email when you register, when some company matches your keyword (as
              stated above) and one email when you de-activate your account, which happens
              automatically once you get notified.
            </p>
            ...
            <p>
              Any misuse of the platform, such as wrongly typing the email and the
            ...
            <br/>
            <p>
              If any questions remain please feel free to contact us through <a
              href="/contact.html" className="highlight">our contact form</a>.
            </p>
          </div>
