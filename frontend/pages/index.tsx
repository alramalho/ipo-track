      ...
      .then(() => {
        setToastProps({
          ...
          message: 'Registered successfully! Check your inbox! (don\'t forget SPAM).\n' +
            'If you didn\'t receive an email please contact our support.'
        })
      })
      .catch(() => {
        setToastProps({
    ...
    <div>
      ...
      <main id="main">
        <div
          ...
          <section
            className='mt-32 mx-8 xl:mx-0 text-left font-sans font-light text-md text-gray-800 break-words'>
          ...
          <section
            className='mt-32 mx-8 xl:mx-0 text-left text-gray-800 font-sans font-light text-md break-words'>
            <h1 className="font-serif text-5xl font-bold mb-5 text-gray-700">
              🧐 How does this work?
            </h1>
            <p>
          ...
          <section className='mt-32 mx-8 xl:mx-0 text-left text-gray-800 text-gray-800 font-sans font-light text-md break-words'>
            ...
            <p>
              A few of them don't have a fixed date yet! Do you want to know when they
              do?&nbsp;
              <em>Click them!</em>
            </p>
          </section>
